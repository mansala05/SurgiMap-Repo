  ...
  const handleSearch = async (queryText = searchText) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://127.0.0.1:8000/search?item_name=${encodeURIComponent(
          finalQuery
        )}`
      );
      ...
      <div style={styles.card}>
        ...
        {message === "0 pharmacies found" && (
          <div style={styles.emptyState}>
            ...
            <p>
              Try searching another surgical kit name such as caesarean,
              appendix, suture, dressing, or general surgery.
            </p>
          </div>
        )}
        ...
        <div style={styles.results}>
          {results.map((item, index) => (
            <div key={index} style={styles.resultCard}>
              ...
              <p>
                <strong>Item:</strong> {item.standard_item_name}
              </p>
              ...
              <p style={styles.verifyNote}>
                Please call or WhatsApp the pharmacy before travelling.
              </p>
