  ...
  return (
    <div className="min-h-screen bg-iceWhite text-obsidian font-sans selection:bg-arcticNavy/10 overflow-x-hidden flex flex-col">
      ...
      <nav className="max-w-[1440px] mx-auto px-8 md:px-16 py-8 flex items-center justify-between w-full">
        ...
        <div className="hidden md:flex items-center gap-12">
          ...
          <a
            ...
            className={`text-sm font-bold uppercase tracking-widest transition-colors ${link === 'Help' ? 'text-arcticNavy' : 'text-steelBlue hover:text-arcticNavy'}`}>
      ...
      <main className="flex-1">
        ...
        {/* FAQ Section */}
        <section className="bg-arcticNavy text-iceWhite py-24 px-8 md:px-16 relative overflow-hidden">
