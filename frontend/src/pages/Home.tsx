...
export function Home() {
  ...
  return (
    <div className="min-h-screen bg-iceWhite text-obsidian font-sans selection:bg-arcticNavy/10 overflow-x-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap gap-8 items-start">
            ...
            <div className="bg-white/90 backdrop-blur-md p-10 rounded-[2.5rem] shadow-xl w-60 h-80 border border-silverMist flex flex-col justify-between hover:-translate-y-4 hover:shadow-2xl transition-all duration-300 cursor-pointer group">
              ...
              <button className="w-full border border-arcticNavy/20 rounded-full py-4 text-xs font-bold uppercase tracking-widest text-arcticNavy group-hover:bg-arcticNavy group-hover:text-iceWhite transition-all">
                Learn More
              </button>
            </div>
          </div>
      ...
      {/* Testimonials */}
      <section className="bg-iceWhite py-32 px-6 md:px-12 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            ...
            <button className="hidden md:flex items-center gap-2 bg-white border border-silverMist text-arcticNavy px-8 py-4 rounded-2xl font-bold hover:bg-arcticNavy hover:text-iceWhite transition-all group shadow-sm">
              Read more stories{' '}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div
              key={i}
              className="bg-white/40 backdrop-blur-md border border-white/40 rounded-[2.5rem] p-10 hover:bg-white/60 hover:border-arcticNavy/20 hover:shadow-2xl hover:shadow-arcticNavy/5 transition-all group flex flex-col justify-between">
              
                <p className="text-obsidian text-2xl font-medium leading-relaxed mb-12 tracking-tight">
                  "{t.quote}"
                </p>
                <div className="flex items-center gap-4 border-t border-silverMist/30 pt-8">
                  <div className="w-14 h-14 rounded-2xl bg-arcticNavy text-iceWhite flex items-center justify-center font-black text-sm shadow-lg shadow-arcticNavy/20 group-hover:scale-110 transition-transform">
                    {t.avatar}
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-steelBlue font-bold uppercase tracking-widest">
                      {t.role}
                    </p>
                  </div>
                </div>
          ...
          <div className="mt-12 text-center md:hidden">
            <button className="w-full bg-white border border-silverMist text-arcticNavy px-10 py-4 rounded-2xl font-bold hover:bg-arcticNavy hover:text-iceWhite transition-all shadow-sm">
              Read more stories
            </button>
          </div>
        </div>
